...
namespace Practical_12_Test_3.Data
{
	public class DatabaseClass
	{
		...
		public List<Employee> FetchTheEmployees()
		{
			...
			using (SqlConnection connection = new SqlConnection(_connectionString))
			{
				...
				while (reader.Read())
				{
					...
					employee.MobileNo = reader["MobileNumber"].ToString();
		...
		{
			string query = "create or alter view ShowData as ( select e.Id as empId, e.FirstName,e.MiddleName, e.LastName, d.Designation, e.DOB, e.MobileNumber, e.Address, e.Salary from Designation d join Employee e on d.Id = e.DesignationId )";
		...
		{
			string query = "create or alter proc ListEmpSortByDOB as begin select e.Id as empId, e.FirstName,e.MiddleName, e.LastName, d.Designation, e.DOB, e.MobileNumber, e.Address, e.Salary from Designation d join employee e on d.Id = e.DesignationId order by DOB end";
		...
		{
			string query = "create or alter proc ListEmpSortByFirstName as begin select e.Id as empId, e.FirstName,e.MiddleName, e.LastName, d.Designation, e.DOB, e.MobileNumber, e.Address, e.Salary from Designation d join employee e on d.Id = e.DesignationId order by FirstName end";
