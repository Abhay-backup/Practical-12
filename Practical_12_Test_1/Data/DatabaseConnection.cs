...
namespace Practical_12_Test_1.Data
{
	public class DatabaseConnection
	{
		...
		{
			string query = "insert into employee values ( 'Abhay','Hiteshbhai','Chothani','2001-04-14','1234567891','gondal');" + 
				"insert into employee values ( 'Abhi','kantibhai','Dashadiya','2002-04-15','1234657891','morbi howsingh board');" +		
